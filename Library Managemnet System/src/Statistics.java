...
PreparedStatement pst;
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(704, 663));
    ...
    public void jTable1(){
        try{
         String sql="select Book_ID,Name,Price,Student_Id,SName,Branch,DateOfIssue from Issue";
    ...
    public void jTable2(){
       try{
         String sql="select Student_ID,Name,Branch,Course,Book_ID,BName,DOR from Return";
         pst=conn.prepareStatement(sql);
         rs=pst.executeQuery();
